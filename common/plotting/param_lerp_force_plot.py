...
def run_lerp_plot(
    ...
    style_mapping = {
        ...
        "legacy_0": {
            ...
            "marker": "o",
            "offset": 0,
        },  # Thick dashed blue with circles
        "custom_0": {
            "color": "#17becf",
            "ls": "-",
            "marker": "x",
            "offset": 2,
        },  # Thin solid cyan with crosses
        ...
        "legacy_1": {
            ...
            "marker": "s",
            "offset": 1,
        },  # Thick dotted red with squares
        "custom_1": {
            "color": "#ff7f0e",
            "ls": "-.",
            "marker": "^",
            "offset": 3,
        },  # Thin dash-dot orange with triangles
    }
    ...
    for i in range(2):
        ...
        print(
            f"For particle {i}, Max. Force Error "
            "|F_{custom} - F_{truth}| = "
            f"{np.max(err)} - is only satisfactory if below 1e-8",
        )
