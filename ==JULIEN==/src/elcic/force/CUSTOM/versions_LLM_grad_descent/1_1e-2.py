...
def get_elcic_forces(system, params: dict):
    ...
    print("="*60)
    print(f"System Dimensions: lx={lx:.4f}, ly={ly:.4f}, lz_full={lz_full:.4f}")
    print(f"Slab Height (h): {h:.4f}, Gap Size: {gap_size:.4f}")
    print(f"Dielectric Constants: Delta_top={delta_t:.4f}, Delta_bot={delta_b:.4f}")
    print(f"Lambda Boundary Layer Thickness: {lambda_:.4f}")
