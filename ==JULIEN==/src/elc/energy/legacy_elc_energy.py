...
def get_legacy_elc_energy(system, params_dict, timeout_duration_sec=10, timeout_return_value=1e3):
    ...
    try:
        ...
        # Clean up: clear the solver so it doesn't try to keep running in the background
        try:
